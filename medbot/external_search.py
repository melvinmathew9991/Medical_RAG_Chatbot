...
def fetch_wikipedia_data(query):
    ...
    async def fetch_all_data():
        ...
        # Wikimedia's API rejects requests without a descriptive User-Agent (robot policy: https://w.wiki/4wJS)
        headers = {"User-Agent": "MedbotRAGChatbot/1.0 (https://github.com/melvinmathew9991/Medical_RAG_Chatbot)"}
